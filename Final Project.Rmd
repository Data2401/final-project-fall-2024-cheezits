...
As a couple of cheese lovers, we will try to determine which cheeses we should be eating and which we to stay away from based on their nutritional content such as...

- Saturated fat, polysaturated fat, protein, carbs, cholesterol, fiber, and calories.
...
cheese %>% select(type, kcal, sat_fat, chol, protein) %>% filter(sat_fat < 1.5, chol < 20) %>% arrange(-protein)
